...
export async function compareHOCR({pageA, pageB, binaryImage, pageMetricsObj, options = {}}) {
  ...
  if (mode == "comb") return {page: pageAInt, metrics: {}, debugLog: debugLog, debugImg: debugImg};
  ...
  return {page: pageAInt, metrics: metricsRet, debugLog: debugLog, debugImg: debugImg};
