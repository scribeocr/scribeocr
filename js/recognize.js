...
export const calcRecognizeRotateArgs = (n) => {
    ...
    return {
        ...
        angleKnown: angleKnown,
        rotateRadians: rotateRadians,
        saveNativeImage: saveNativeImage,
        saveBinaryImageArg: saveBinaryImageArg
    }
...
export const recognizePage = async (scheduler, n, legacy = true, lstm = true, options = {}) => {
    ...
    const { angleThresh, angleKnown, rotateRadians, saveNativeImage, saveBinaryImageArg} = calcRecognizeRotateArgs(n);
    ...
    const res = await scheduler.addJob('recognizeAndConvert2', {
        ...
        }, n: n, knownAngle: globalThis.pageMetricsArr[n].angle, pageDims: pageDims
    });
